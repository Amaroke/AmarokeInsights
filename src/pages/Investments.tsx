        ...
        <Container>
            ...
            <div className="space-y-4">
              ...
              >
                <p>
                  ...
                  L'objectif est de trouver un équilibre adapté à son profil et
                  à l'horizon de placement.
                </p>

                <p>
                  Avant d'investir, il est nécessaire de définir l'objectif,
                  l'horizon de temps et le profil de risque. Ces trois éléments
                  servent de guide pour sélectionner les placements appropriés.
                </p>
                ...
                <p>
                  Il est important de ne pas rechercher un enrichissement rapide
                  et d'éviter que les décisions soient guidées par les émotions.
                  La patience, la discipline et la diversification sont les
                  meilleures pratiques pour limiter les risques. Il est
                  important de noter que l'investissement à risque n'est pas
                  recommandé pour les personnes sensibles aux émotions ou qui
                  craignent la perte de capital. Pour ceux qui souhaitent
              ...
              >
                <p className="leading-relaxed mb-3">
                  ...
                  investir
                  <strong> la même somme régulièrement</strong> (chaque mois par
                  exemple), plutôt que d'investir tout son capital d'un coup.
            ...
            <div className="space-y-4">
              ...
              >
                <p>
                  ...
                  représentant une part du capital d'une entreprise. Détenir une
                  action signifie devenir copropriétaire et bénéficier de droits
                  comme :
                </p>
                ...
                <p>
                  Les actions dites de préférences peuvent octroyer d'avantages
                  de droits. De plus posséder des actions permet de s'exposer à
                  de potentielles plus-values si le cours de l'action augmente.
                </p>
                <p>
                  Il existe les actions cotées et les actions non cotées. Les
                  actions cotées sont négociées sur des marchés boursiers comme
                  Euronext Paris. Elles sont liquides, ce qui permet de les
                  acheter ou de les revendre facilement. Les actions non cotées,
                  émises par des <Term id={"PME"} /> ou des <Term id={"TPE"} />,
                  ne sont pas négociées en bourse. Elles sont moins liquides et
                  plus risquées, et leur revente peut être difficile voire
                  impossible. Les actions peuvent être au porteur ou
                  nominatives. Les actions au porteur ne permettent pas
                  d'identifier l'actionnaire auprès de la société, tandis que
                  les actions nominatives identifient l'actionnaire, qui peut
                ...
                <p>
                  ...
                  <strong>place de cotation</strong>, principalement en bourse.
                  En France, la plus connue est{" "}
                  ...
                  <p>
                    ...
                    <strong>nom</strong>, qui correspond généralement au nom de
                    la société émettrice, et son <strong>ticker</strong>, un
                    code unique utilisé sur les marchés financiers pour
                ...
                <p>
                  ...
                  actions les plus liquides sont cotées en continu de 9h à 17h40
                  (pour la bourse de Paris). Les autres valeurs sont échangées
                  via des <strong>fixing</strong> à horaires fixes : 11h30 et
                  16h30 (ou 15h00 pour le marché libre, non réglementé,
                  principalement utilisé par des <Term id={"PME"} />
                  ). Chaque marché financier dans le monde possède ses propres
                  horaires d'ouverture et de fermeture selon son fuseau horaire.
                </p>
                ...
                <p>
                  ...
                  l'ordre au marché, avec des services et coûts propres à chaque
                  prestataire.
                </p>
                <h3 className="font-semibold mt-4">
                ...
                <p>
                  Les risques incluent la perte totale du capital si la société
                  fait faillite, la fluctuation du cours selon les résultats et
                  la politique de dividendes, et des différences de risques
                  selon les sociétés et les périodes. Les actions non cotées
                  présentent un risque de liquidité important.
                </p>
              </InfoBubble>
              ...
              >
                ...
                <p>
                  ...
                  prix varie en continu selon l'offre et la demande. Ils peuvent
                  être standard (suivi passif d'un indice comme le{" "}
                  ...
                  liquidative, calculée à partir du portefeuille qu'il réplique,
                  et de la valeur de marché, qui fluctue selon l'offre et la
                  demande. Des acteurs comme les émetteurs ou arbitragistes
                  assurent la liquidité et veillent à ce que le prix reste
                  proche de la valeur réelle du panier d'actions.
                </p>
                ...
                <p>
                  ...
                  pour ETF à effet de levier, <strong>Inverse</strong> pour ETF
                  inversé, ou encore la mention d'un secteur ou d'une région
                  spécifique (exemple, Emerging Markets pour les pays
                ...
                <p>
                  ...
                  opérationnels du fonds. Les coûts de courtage pour l'achat et
                  la vente sont similaires à ceux des actions et varient selon
                  le courtier. Les ETF complexes, comme ceux à effet de levier,
                  inversés ou sur des matières premières, ont généralement des
                  frais plus élevés en raison de la complexité de leur gestion
                  et des instruments utilisés.
                </p>

                <p>
                  Les ETF offrent plusieurs avantages, ils sont simples à
                  acheter et vendre, peu coûteux, transparents et permettent de
                  diversifier facilement un portefeuille. Certains permettent
                  également de se couvrir contre la volatilité ou d'utiliser un
                  effet de levier. Comme tout investissement, ils comportent des
                  risques, la valeur peut fluctuer selon les marchés, certains
                  ETF peuvent manquer de liquidité, leur performance peut
                  légèrement s'écarter de l'indice (tracking error), et l'effet
                  de levier, pour les ETF complexes, peut amplifier les pertes.
                </p>
              </InfoBubble>
              ...
              >
                <p>
                  ...
                  entreprise ou collectivité). En échange, l'emprunteur promet
                  de vous rendre votre argent à une date précise et de vous
                  verser parfois des intérêts. Chaque obligation a son propre
                  code (ISIN), un taux d'intérêt appelé coupon, et une date
                  d'échéance. Son prix peut varier sur les marchés et est
                ...
                <ul className="list-disc list-inside ml-4">
                  ...
                  <li>
                    ...
                    seulement à certaines périodes selon l'évolution des taux du
                    marché. Elles protègent le capital, mais le revenu peut
                  ...
                  <li>
                    ...
                    rendement provient de la différence entre le prix d'achat et
                ...
                <p>
                  ...
                  taux de rendement effectif combine ces deux sources et diffère
                  souvent du taux de coupon.
                </p>
                ...
                <p>
                  ...
                  d'une émission ou une obligation déjà existante sur le marché
                  secondaire. Le prix que vous payez peut varier selon l'offre
                  et la demande, et des intérêts accumulés depuis le dernier
                  paiement peuvent s'ajouter au prix. Pour vendre, vous la
                  revendez également via votre banque ou plateforme, au prix du
                  marché au moment de la vente.
                </p>
                <p>
                ...
                <p>
                  La notation d'une obligation indique la solidité financière de
                  l'émetteur (État ou entreprise) et sa capacité à rembourser.
                  Elle est fournie par des agences comme Standard & Poor's
                  (S&P). Une bonne note signifie que l'émetteur est fiable et a
                  peu de risques de défaut, tandis qu'une note faible indique un
                  risque plus élevé. Elles permettent aux investisseurs de
                  comprendre rapidement le niveau de risque d'une obligation et
                ...
                <ul className="list-disc list-inside ml-4">
                  ...
                  <li>
                    <strong>AA / A :</strong> fiable, mais un peu plus sensible
                  ...
                  <li>
                    ...
                    rencontrer des difficultés en cas de problèmes économiques.
                  </li>
                  <li>
                ...
                <ul className="list-disc list-inside ml-4">
                  <li>
                    ...
                    capital et les intérêts suivent l'inflation pour protéger le
                    pouvoir d'achat.
                  </li>
                  <li>
                    <strong>Obligations perpétuelles :</strong> elles n'ont pas
                    de date de remboursement fixe, mais l'émetteur peut parfois
                    les rembourser à certaines dates.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    obligation avec un ou plusieurs instruments financiers pour
                    ajuster le risque et le rendement.
                  </li>
                  <li>
                    <strong>
                      Obligations remboursables par anticipation :
                    </strong>{" "}
                    l'émetteur peut décider de rembourser l'obligation avant son
                    échéance selon certaines conditions.
                  </li>
                </ul>
              </InfoBubble>
              ...
              >
                <p>
                  ...
                  regroupent différents actifs financiers tels que des actions,
                  de l'immobilier, des obligations, etc. Plutôt que d'acquérir
                  directement ces titres un à un, un investisseur peut souscrire
                  à un fonds et ainsi détenir une part d'un portefeuille géré
                  par des professionnels. Pour souscrire une part d'un{" "}
                  <Term id={"FCP"} /> ou acquérir une action d'une{" "}
                  ...
                  traités, en raison de la centralisation et de la fréquence de
                  calcul (parfois hebdomadaire) du fond.
                </p>
                ...
                <p className="mt-3">
                  ...
                  (DIC), qui est contrôlé par l'Autorité des Marchés Financiers.
                  Ce DIC est indispensable pour s'informer sur le produit et le
                  comparer aux autres OPC.
                </p>
                ...
                <ul className="list-disc list-inside ml-4">
                  ...
                  <li>
                    Leurs parts peuvent être achetées ou revendues à leur valeur
                    liquidative
                  </li>
                </ul>

                <p className="mt-3">Il existe deux grandes catégories d'OPC.</p>
                ...
                <ul className="list-disc list-inside ml-4">
                  ...
                  <li>
                    ...
                    Alternatifs) regroupent des placements plus spécialisés tels
                    que les fonds immobiliers, de capital-investissement ou de
                    stratégie alternative. Ils disposent d'une plus grande
                    flexibilité de gestion, mais présentent généralement un
                    niveau de risque plus élevé et une liquidité plus limitée.
                  </li>
                </ul>
                ...
                <p className="mt-3">
                  ...
                  lui, est une copropriété de différents biens financiers où les
                  investisseurs détiennent des parts, sans pour autant disposer
                  de droits liés à la qualité d'actionnaire.
                </p>
                ...
                <ul className="list-disc list-inside ml-4">
                  <li>
                    ...
                    produits à court terme, ils présentent un risque très faible
                    mais un rendement limité.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    obligations et produits monétaires, avec un niveau de risque
                    dépendant de la répartition entre ces actifs.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Fonds complexes</strong> : utilisent des stratégies
                    avancées comme l'effet de levier ou les produits dérivés
                    pour amplifier la performance. Ils sont destinés à des
                    investisseurs avertis en raison du risque accru.
                  </li>
                </ul>

                <p className="mt-3">
                  Il convient de noter que l'investissement dans des fonds
                  entraîne des <strong>frais de gestion</strong> et autres coûts
                  associés à l'exploitation et à l'administration du fonds. Ces
                  frais réduisent le rendement effectif pour l'investisseur. Par
                  ailleurs, bien que l'objectif des fonds soit souvent de
                  surperformer le marché ou un indice de référence, aucune
                  garantie de performance n'est fournie.
                </p>
              </InfoBubble>
            </div>
          </section>
            ...
            <div className="space-y-4">
              ...
              >
                <p>
                  ...
                  (appartement, maison, immeuble) pour le louer ou le revendre.
                  C'est un investissement tangible avec des revenus réguliers si
                  le bien est loué et une plus-value potentielle à la revente.
                </p>
                <p>Les principaux critères à considérer sont :</p>
                <ul className="list-disc list-inside ml-4">
                  <li>
                    <strong>Localisation :</strong> la valeur et la demande
                    locative dépendent fortement de la ville, du quartier et des
                    commodités.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Rendement locatif :</strong> rapport entre le loyer
                    annuel et le prix d'achat.
                  </li>
                  <li>
              ...
              >
                <p>
                  ...
                  sans acheter directement un bien. La société de gestion
                  collecte des fonds auprès d'investisseurs pour acheter et
                  gérer un parc immobilier, et redistribue les revenus locatifs
                  proportionnellement aux parts détenues.
                </p>
                <p>Avantages :</p>
                <ul className="list-disc list-inside ml-4">
                  <li>
                    Accès à l'immobilier avec un ticket d'entrée faible comparé
                    à l'achat direct.
                  </li>
                  <li>
                ...
                <ul className="list-disc list-inside ml-4">
                  <li>
                    Liquidité limitée, il peut être long et complexe de revendre
                    ses parts.
                  </li>
                  <li>
                    Frais d'entrée et de gestion qui réduisent le rendement net
                    pour l'investisseur.
                  </li>
                  <li>
                    Risque de perte en capital, si la valeur du parc immobilier
                    baisse ou si certains locataires ne paient pas leurs loyers.
                  </li>
                  <li>
          ...
          <section id="alternatives" className="scroll-mt-22 mb-12">
            ...
            <div className="space-y-4">
              ...
              >
                <p>
                  Les matières premières comme l'or, l'argent ou le pétrole sont
                  souvent utilisées pour diversifier un portefeuille et se
                  protéger contre l'inflation ou les crises économiques. Plutôt
                  que d'acheter physiquement ces actifs, la plupart des
                  investisseurs passent par des ETC (Exchange Traded
                  Commodities), des produits cotés en bourse qui suivent le prix
                  de la matière première sous-jacente. Les ETC permettent
                  d'investir facilement, de profiter de la liquidité du marché
                  et de sécuriser le stockage, tout en reproduisant l'évolution
                  du prix du métal ou de la matière première choisie.
                </p>
                <p>
                  Avantages :
                ...
                <p>
                  ...
                  <ul className="list-disc list-inside">
                    ...
                    <li>
                      ...
                      spécifiques pour les métaux précieux, ce qui peut réduire
                      le rendement net.
                    </li>
                  </ul>
                </p>
              ...
              >
                <p>
                  ...
                  technologiques. Ils sont très volatils, mais peuvent offrir un
                  potentiel de rendement élevé et une diversification différente
                ...
                <p>
                  ...
                  <ul className="list-disc list-inside">
                    <li>
                      Diversification par rapport aux actifs traditionnels comme
                    ...
                    <li>
                      Possibilité d'investir de manière fractionnée et de gérer
                      facilement le portefeuille via des plateformes en ligne.
                    </li>
                    <li>
                ...
                <p>
                  ...
                  <ul className="list-disc list-inside">
                    ...
                    <li>
                      Risque technologique, bugs, piratages ou défaillances des
                      plateformes.
                    </li>
                    <li>
                      Réglementation et fiscalité incertaines dans certains
                      pays, avec des obligations déclaratives spécifiques et des
                      taxes sur les plus-values.
                    </li>
                  </ul>
                </p>
                <p>
                  Une page est consacrée à ces actifs dans les pages suivantes.
                  Je ne détaille pas plus ici.
                </p>
              </InfoBubble>
              ...
              >
                <p>
                  ...
                  dans des entreprises non cotées en bourse, souvent en phase de
                  croissance, de transformation ou de transmission. L'objectif
                  est de financer leur développement et de réaliser une
                  plus-value lors de leur revente ou de leur introduction en
                  bourse. Ce type d'investissement s'inscrit dans une optique de
                  long terme et s'adresse généralement à des investisseurs prêts
                  à immobiliser leur capital plusieurs années.
                </p>
              </InfoBubble>
              ...
              >
                <p>
                  ...
                  qui utilisent des stratégies financières avancées pour générer
                  de la performance, indépendamment de la direction des marchés.
                  Ils peuvent recourir à la vente à découvert, à l'effet de
                  levier, à l'arbitrage ou encore à des produits dérivés. Leur
                  objectif est souvent d'obtenir un rendement absolu,
                  c'est-à-dire positif quelle que soit la conjoncture boursière.
                </p>
                <p>
                  Avantages :
                  <ul className="list-disc list-inside">
                    <li>
                      Recherche de performance stable et décorrélée des marchés
                      traditionnels.
                    </li>
                    <li>
                      Grande flexibilité stratégique permettant de s'adapter aux
                      cycles économiques.
                    </li>
                    <li>
                      Accès à des opportunités d'investissement sophistiquées et
                      diversifiées.
                    </li>
                    <li>
                ...
                <p>
                  ...
                  <ul className="list-disc list-inside">
                    ...
                    <li>
                      Accès restreint, la plupart des Hedge Funds sont réservés
                      aux investisseurs qualifiés ou institutionnels.
                    </li>
                  </ul>
                </p>
              </InfoBubble>
              ...
              >
                <p>
                  ...
                  que les cartes Pokémon. Ces actifs reposent sur la rareté, la
                  demande des collectionneurs et la valeur culturelle ou
                ...
                <p>
                  ...
                  <ul className="list-disc list-inside">
                    ...
                    <li>
                      Valeur tangible et esthétique, l'objet peut être conservé,
                      exposé ou utilisé.
                    </li>
                    <li>
