          ...
          <section id="current-accounts" className="scroll-mt-22 mb-12">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <br />
                <strong>Inconvénients :</strong> Responsabilité partagée, aucun
                rendement, frais bancaires possibles.
                <br />
              </InfoBubble>
            </div>
          </section>
          <section id="saving-account" className="scroll-mt-22 mb-12">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <br />
                <strong>Avantages :</strong> Sécurisé, fonds disponibles à tout
                moment.
                <br />
              ...
              >
                ...
                sociaux.
                <br />
                <strong>Avantages :</strong> Rendement plus élevé que le Livret
                A et LDDS.
                <br />
                <strong>Inconvénients :</strong> Plafond limité, conditions de
                revenus strictes.
                <br />
                <strong>Stratégie :</strong> Épargne de précaution, avec un taux
                supérieur aux autres livrets réglementés couvrant la même
              ...
              >
                ...
                potentiellement supérieur au livret A, disponibilité immédiate.
                <br />
              ...
              <InfoBubble
                ...
                color="text-blue-400"
              >
                Livret pour préparer un projet immobilier, possibilité de prêt à
                taux préférentiel.
                <br />
                <strong>Taux :</strong> 2% pour les PEL ouverts à partir du 1er
                janvier 2026 / Plafond 61 200 €, attention cependant le taux est
                bloqué à l'ouverture du plan, certains PEL ouverts il y a
                plusieurs années ont des taux plus élevés. Il est important de
                vérifier le taux à l'ouverture et lors de la clôture. Certains
                PEL ouverts il y a longtemps ont des taux très intéressants.
                <br />
                <strong>Fiscalité :</strong> Gains soumis au <Term id={"PFU"} />
                .
                <br />
          ...
          <section id="investment-account" className="scroll-mt-22 mb-12">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                limité aux actions de l'Union Européenne (même si certains fonds
                peuvent inclure des titres non européens).
                <br />
              ...
              >
                ...
                <br />
                <strong>Fiscalité :</strong> Déduction des versements du revenu
                imposable, report d'imposition, prélèvements sociaux à la
              ...
              >
                ...
                abattement annuel 4 600€ (célibataires) ou 9 200€ (couples) sur
                les gains, prélèvements sociaux 18,6%, succession optimisée.
                <br />
              ...
              >
                ...
                l'année des 30 ans.
                <br />
                <strong>Stratégie :</strong> Investissements <Term id={"ESG"} />
                , long terme.
              </InfoBubble>
            </div>
          </section>
