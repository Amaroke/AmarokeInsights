      ...
      <Container>
        ...
        <section id="risks" className="scroll-mt-22">
          ...
          <div className="space-y-4">
            ...
            >
              <p className="leading-relaxed">
                Un actif difficile à vendre sans perte (par exemple, immobilier
                rare ou actions peu échangées) expose à ce risque. On le réduit
                en gardant une part de liquidités et en diversifiant.
              </p>
            </InfoBubble>
