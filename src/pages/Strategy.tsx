            ...
            <div className="space-y-6">
              ...
              >
                <p className="leading-relaxed">
                  ...
                  donc <b>subjectives</b>. Elles ne doivent pas être
                  interprétées comme des <b>vérités absolues</b> ni comme des
                  <b> conseils à suivre</b>, mais simplement comme une
                  expression de ma façon de voir les choses à l’instant actuel.
                </p>
              </InfoBubble>
              ...
              >
                <p className="leading-relaxed whitespace-pre-line">
                  ...
                  permet. Avec 1 million d’euros investis, en appliquant une
                  règle simple comme les
                  ...
                  <b> liberté</b>, pas des objets. Plus de détails dans la
                  partie où j’explique ce qu’est le <b>FIRE</b>.
                </p>
              </InfoBubble>
              ...
              >
                <p className="leading-relaxed whitespace-pre-line">
                  Il y a 20 ans, tu savais exactement ce que tu ferais
                  aujourd’hui ? <b>Probablement pas</b>. Donc je verrai bien le
                  moment venu. Par contre, il y a une chose dont je suis sûr :
                  la <b>routine imposée</b>, comme quand on était enfant, école,
              ...
              >
                <p className="leading-relaxed whitespace-pre-line">
                  ...
                  <b>priorités</b>. Certains postes de dépenses pèsent
                  énormément sur un budget. Par exemple, un enfant peut coûter
                  des dizaines voire des centaines de milliers d’euros, et une
                  voiture représente aussi plusieurs milliers d’euros par an
                  entre l’achat, l’entretien, l’assurance et le carburant. De
                  mon côté, mes loisirs coûtent très peu. Je joue aux jeux
                  ...
                  (n'aller pas croire que j'ai tout calculé en ce but c'est
                  juste une constatation à but d'explication). J’utilise des
                  transports en commun (gratuit la majorité du temps). Au final,
                  mon mode de vie est simple et peu dépensier, ce qui me permet
                  d’épargner une grande partie de mes revenus. Et attention, ça
                  ne veut pas dire que certaines dépenses sont “mauvaises”.
                  Avoir des enfants ou dépenser plus pour son confort, c’est un
                  choix de vie totalement valide. Simplement, ce ne sont pas des
                  choses qui m’attirent <b>personnellement</b> et{" "}
                  <b>pour le moment</b>.
                </p>
              </InfoBubble>
              ...
              >
                <p className="leading-relaxed whitespace-pre-line">
                  ...
                  juste en dehors. Pendant ce temps, l’inflation fait perdre de
                  la valeur à ton argent et ceux qui investissent continuent de
                  faire croître leur patrimoine. Investir, ce n’est pas soutenir
                  aveuglément tout ce qui existe. C’est utiliser les règles du
                  jeu actuel. Et surtout, ça te donne des <b>options</b>. Plus
                  de liberté pour choisir ton travail, ton rythme de vie, ou
                  même soutenir des causes qui te tiennent à cœur. Et si le
                  système change, je m’adapterai. L’idée n’est pas de défendre
                  un modèle coûte que coûte, mais de rester pragmatique et de
                  faire au mieux avec les règles du moment. Refuser d’investir
                  par principe peut sembler moral, mais dans les faits, ça te
                  pénalise surtout toi, sans réellement impacter le système. Par
                  ailleurs, je suis assez critique des systèmes politiques
                  ...
                  enjeux. Idéalement, je préférerais des systèmes de décision
                  plus basés sur la compétence, la méthode et les faits, avec
                  une vision beaucoup plus unifiée et ambitieuse pour l’espèce
                  humaine. Mais encore une fois, c’est ma vision{" "}
                  <b>personnelle</b> et <b>actuelle</b>, et je respecte
                  totalement les opinions différentes. Mais dans tous les cas,
                  je fais avec le monde tel qu’il est aujourd’hui, pas tel que
                  je l’imagine dans l’absolu.
                </p>
              </InfoBubble>
            </div>
          </section>
