    ...
    >
      <Container gap="sm">
        <Disclaimer title="Page en cours de création">
          Cette page est en cours de construction. Le contenu actuel n'est qu'un
          premier jet, publié au fur et à mesure des sujets traités. D'autres
          parties viendront le compléter, et celles déjà en ligne sont
          susceptibles d'être revues ou reformulées.
        </Disclaimer>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="leading-relaxed mt-2">
                ...
                <b>tant que l'argent reste dans le PEA</b>, vous ne payez{" "}
                <b>aucun impôt</b>, même si vous{" "}
                ...
                <b>arbitrer librement</b> (vendre un <Term id={"ETF"} /> pour en
                acheter un autre, sécuriser des plus-values, rééquilibrer votre
                portefeuille) sans aucune fiscalité, ce qui laisse l'intégralité
                de vos gains continuer à travailler grâce aux intérêts composés.
              </p>
              ...
              <ExampleBox>
                ...
                plus de 5 ans, contre <b>29 686 €</b> en CTO ou PEA retiré trop
                tôt - soit <b>+3 673 €</b> de gain supplémentaire uniquement
                grâce à l'exonération d'impôt sur le revenu (12,8 % de la
                plus-value économisés). Un retrait <b>avant 5 ans</b> est taxé
                comme un CTO au <Term id={"PFU"} />, l'avantage disparaît et le
                plan est clôturé.
              </ExampleBox>
            </InfoBubble>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="leading-relaxed mt-2">
                ...
                revendent juste après la succession, aucune plus-value taxable
                au titre de l'impôt sur le revenu n'est constatée, même si le
                titulaire initial avait acheté ces titres des décennies plus tôt
              ...
              <ExampleBox>
                ...
                plus-value latente de <b>40 000 €</b> accumulée de votre vivant
                n'est jamais taxée au titre de l'impôt sur le revenu. Seuls les
                droits de succession s'appliquent, sur la valeur totale
                transmise.
              </ExampleBox>
              ...
              <p className="leading-relaxed mt-2">
                ...
                différemment selon la date des versements. Le CTO, souvent perçu
                comme fiscalement désavantageux comparé au <Term id="PEA" /> ou
                à l'
                <Term id="AssuranceVie" />, retrouve donc un intérêt réel dans
                une logique de détention très long terme, avec un objectif de{" "}
                <strong>transmission</strong> plutôt que de consommation du
          ...
          <div className="space-y-4">
            ...
            >
              <p className="leading-relaxed">
                ...
                <strong>en franchise totale de droits de donation</strong>. Cet
                abattement est personnel à chaque lien parent-enfant, et se
                cumule donc naturellement au sein d'une famille.
              </p>

              <p className="leading-relaxed mt-2">
                Point essentiel : cet abattement n'est{" "}
                <strong>pas annuel</strong>, il se renouvelle tous les{" "}
                <strong>15 ans</strong> (de manière glissante, pas au 1ᵉʳ
                janvier). Une fois les 15 ans écoulés depuis la dernière
                donation, la totalité du plafond redevient disponible.
              </p>
              ...
              <p className="leading-relaxed mt-2">
                ...
                (de 5 % à 45 % selon le montant transmis). Cet abattement se
                cumule avec d'autres dispositifs, notamment le{" "}
                <strong>don familial de sommes d'argent</strong> (31 865 €, sous
                conditions d'âge du donateur et du bénéficiaire, également
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="leading-relaxed mt-2">
                ...
                prix d'acquisition (plateforme disparue, historique perdu, achat
                en espèces non tracé...), l'administration peut retenir un{" "}
                <strong>prix d'acquisition nul</strong>. Résultat, ce n'est plus
                seulement votre gain réel qui est taxé, mais la{" "}
              ...
              <ExampleBox>
                ...
                d'achat, l'administration peut retenir un prix d'acquisition nul
                : vous seriez alors imposé au <Term id={"PFU"} /> sur les{" "}
