...
const BankingAccounts: React.FC = () => {
  ...
  return (
    <div className="flex h-screen text-gray-300 bg-[#12121b]">
      ...
      >
        <div className="mt-8 mx-8 flex items-center bg-yellow-500/20 border-l-4 border-yellow-500 text-yellow-900 p-4 rounded-md mb-6">
          ...
          <section id="types-of-accounts" className="scroll-mt-22 mb-12">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                sociaux
                <br />
                <strong>Avantages :</strong> Sécurisé, accessible immédiatement.
                <br />
              ...
              <InfoBubble
                ...
                color="text-blue-400"
              >
                <strong>Description :</strong> Livret pour les jeunes de 12 à 25
                ans, taux attractif.
                <br />
                <strong>Type :</strong> Épargne
                <br />
              ...
              >
                ...
                immobilier.
                <br />
                <strong>Inconvénients :</strong> Rendement faible, fonds bloqués
                minimum 18 mois.
                <br />
              ...
              >
                ...
                cependant le taux est bloqué à l'ouverture du plan, certains PEL
                ouverts il y a plusieurs années ont des taux plus élevés. Il est
                important de vérifier le taux à l'ouverture et lors de la
                clôture. Certains PEL ouverts il y a longtemps ont des taux très
                intéressants.
                <br />
              ...
              <InfoBubble
                ...
                color="text-blue-400"
              >
                <strong>Description :</strong> Compte d’épargne flexible proposé
                par les banques.
                <br />
                <strong>Type :</strong> Épargne
                <br />
